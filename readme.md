...
- [DEMO LINK](https://danie010830.github.io/layout_moyo-header/)
- [TEST REPORT LINK](https://danie010830.github.io/layout_moyo-header/report/html_report/)

❗️ Copy this `Checklist` to the `Pull Request` description after links, and put `- [x]` before each point after you checked it.

- [x] Header height is set in 1 place (for the links)- [x]- [ ] Content is vertically centered (for any header height)
